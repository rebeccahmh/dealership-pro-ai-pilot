      ...
      <div className="flex items-center space-x-1">
        ...
        <div className="bg-autoretech-blue text-white rounded-full flex items-center">
          {actions.includes('archive') && (
            <Button variant="ghost" className="text-white hover:bg-autoretech-blue/90 px-3" size="sm" onClick={handleArchive}>
          ...
          {actions.includes('email') && (
            <Button variant="ghost" className="text-white hover:bg-autoretech-blue/90 px-3" size="sm" onClick={handleEmail}>
          ...
          {actions.includes('export') && (
            <Button variant="ghost" className="text-white hover:bg-autoretech-blue/90 px-3" size="sm" onClick={handleExport}>
          ...
          {actions.includes('print') && (
            <Button variant="ghost" className="text-white hover:bg-autoretech-blue/90 px-3" size="sm" onClick={handlePrint}>
          ...
          {actions.includes('close') && (
            <Button variant="ghost" className="text-white hover:bg-autoretech-blue/90 rounded-r-full px-3 ml-1" size="sm" onClick={handleClose}>
              <X className="h-5 w-5" />
            </Button>
          )}
        </div>
